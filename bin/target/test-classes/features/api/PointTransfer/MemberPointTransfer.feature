...
Scenario: To verify that the member cannot transfer the Blocked points 
	...
	Then Member should not be able to transfer blocked points type with status code 400. 
...
Scenario: To verify that the target member can not do redemption reversal after point merge 
	...
	And Target member should not be able to do redemption reversal after point transfer with status code 400
