...
#	Then Member should get the successful message for points adjustment with statuscode <statuscode>
#	And Member history is disapayed successfully with status code 200 
#	Examples: 
#		|  date                     | receiptId|debitorId|amount|description      |statuscode|
#		| "2020-10-10T00:00:00.000Z"| "adj1"   |"SHOP_A1"|50.0|"Test Adjustment"| 200|
...
#	Then source member for adjustment should be enroll successfully with status code 200
#	And Member should get the successful message for points adjustment with statuscode <statuscode>
#	And Member should get the error message for points adjustment with statuscode <statuscode> 
#	And target member history is successfully for adjustment with status code 200 
#	Examples: 
#		|  date                     | receiptId|debitorId|amount|description      |statuscode|
#		| "2020-10-10T00:00:00.000Z"| "adj1"   |"SHOP_A1"|50.0|"Test Adjustment"| 200|		
